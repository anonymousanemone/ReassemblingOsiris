...
function startObserving(sceneEl, regionEl, imgEl) {
  ...
  tryToUpdateImage(sceneEl, regionEl, imgEl, defaultImageSrc, captionEl);
...
function tryToUpdateImage(sceneEl, regionEl, imgEl, defaultImageSrc, captionEl) {
    ...
    if (captionEl) {
      captionEl.textContent = currentRegion + " — " + currentScene;
    }
